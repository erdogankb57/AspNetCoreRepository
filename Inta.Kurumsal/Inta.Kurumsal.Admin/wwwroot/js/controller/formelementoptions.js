...
var loadRecord = function () {
    ...
    table = $('#dataTable').DataTable({
        "ajax":
        {
            "url": "/Admin/FormElementOptions/GetDataList",
            "type": "post",
            "datatype": "json",
            "data": function (d) {
                return $.extend({}, d, {
        ...
        "columns": [
            ...
            },
            {
                "mRender": function (data, type, row) {
                    ...
                    link = '<a href="javascript:void(0)" onclick="javascript:deleteRecord(' + row.Id + ')" class="editor_remove">Sil</a> <a href="javascript:void(0)" onclick="addRecordModal(' + row.Id + ')" class="editor_edit">Düzenle</a>';
...
var addRecordModal = function (id) {
    ...
    $.ajax({
        url: "/Admin/FormElementOptions/Add",
        type: "POST",
        dataType: 'html',
        data: {
            "id": id, "FormElementId": FormElementId
        },
...
var deleteRecord = function (id) {
    ...
    if (onay) {
        ...
        $.ajax({
            url: "/Admin/FormElementOptions/Delete",
            type: "POST",
            dataType: 'json',
...
$(document).ready(function () {
    ...
    $("#saveForm").submit(function (e) {
        ...
        $.ajax({
            url: "/Admin/FormElementOptions/Save",
            type: "POST",
            data: formData,
            dataType: 'json',
            contentType: false,
