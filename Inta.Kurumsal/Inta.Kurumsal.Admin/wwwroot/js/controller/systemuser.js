...
var addUserRole = function () {
    ...
    userRole.push(id);
    $("#tblRoleList tbody").append("<tr><td style='width:75%'>" + $("#SystemRole option:checked").text() +"</td><td style='text-align:center;'>Sil</td></tr>")
}
...
var loadRecord = function () {
    ...
    table = $('#dataTable').DataTable({
        "ajax":
        {
            "url": "/Admin/SystemUser/GetDataList",
            "type": "post",
            "datatype": "json",
            "data": function (d) {
                return $.extend({}, d, {
